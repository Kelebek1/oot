...
void EnKakasi_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    this->unk_1AE = this->actor.posRot.rot;
...
void func_80A8F28C(EnKakasi* this) {
    ...
    Math_SmoothScaleMaxMinS(&this->actor.shape.rot.x, this->unk_1AE.x, 5, 0x2710, 0);
    Math_SmoothScaleMaxMinS(&this->actor.shape.rot.y, this->unk_1AE.y, 5, 0x2710, 0);
    Math_SmoothScaleMaxMinS(&this->actor.shape.rot.z, this->unk_1AE.z, 5, 0x2710, 0);
}

void func_80A8F320(EnKakasi* this, GlobalContext* globalCtx, s16 arg2) {
    ...
    if (this->unk_19A != 0) {
        ...
        if (((s16)this->skelAnime.animCurrentFrame == 0xB) || ((s16)this->skelAnime.animCurrentFrame == 0x11)) {
...
void func_80A8F660(EnKakasi* this, GlobalContext* globalCtx) {
    f32 tmp = SkelAnime_GetFrameCount(&D_06000214.genericHeader);
    s16 tmp2 = tmp;

    SkelAnime_ChangeAnim(&this->skelAnime, &D_06000214, 1.0f, 0.0f, tmp2, 0, -10.0f);
    this->actor.textId = 0x4076;
    this->unk_196 = 6;
    if (LINK_IS_CHILD) {
        this->unk_194 = 0;
        if (gSaveContext.unk_F40 != 0) {
