...
typedef struct Fishing {
    ...
    /* 0x01D4 */ u8 unk_1D4;
    /* 0x01D5 */ u8 unk_1D5;
    /* 0x01D6 */ char unk_1D6[0x2];
    /* 0x01D8 */ SkelAnime skelAnime;
    /* 0x021C */ z_Light* unk_21C;
    /* 0x0220 */ LightInfoPositional unk_220;
    /* 0x0230 */ ColliderJntSph unk_230;
    /* 0x0250 */ ColliderJntSphItem unk_250;
    /* 0x0290 */ char unk_290[0x2C0];
} Fishing; // size = 0x0550
