...
/* 00FC8 80950288 3C108096 */  lui     $s0, %hi(D_8095C044+0xB4)       ## $s0 = 80960000
/* 00FCC 8095028C 3C118096 */  lui     $s1, %hi(D_8095C17C+0x5A)       ## $s1 = 80960000
/* 00FD0 80950290 AE6C0198 */  sw      $t4, 0x0198($s3)           ## 00000198
/* 00FD4 80950294 2631C1D6 */  addiu   $s1, $s1, %lo(D_8095C17C+0x5A)  ## $s1 = 8095C1D6
/* 00FD8 80950298 2610C0F8 */  addiu   $s0, $s0, %lo(D_8095C044+0xB4)  ## $s0 = 8095C0F8
...
/* 01120 809503E0 3C108096 */  lui     $s0, %hi(D_8095C044+0x3C)       ## $s0 = 80960000
/* 01124 809503E4 3C118096 */  lui     $s1, %hi(D_8095C17C+0x1E)       ## $s1 = 80960000
/* 01128 809503E8 2631C19A */  addiu   $s1, $s1, %lo(D_8095C17C+0x1E)  ## $s1 = 8095C19A
/* 0112C 809503EC 2610C080 */  addiu   $s0, $s0, %lo(D_8095C044+0x3C)  ## $s0 = 8095C080
